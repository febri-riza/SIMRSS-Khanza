                    ...
                    <div class="fakecard-content">
                        ...
                        echo "<table width='100%' align='center' border='0' class='tbl_form' cellspacing='0' cellpadding='0'>
                                <tr>
                                    ...
                                    <td>
                                        <center class='cell'>
                                  <font size='10' color='#FFFFFF' face='Tahoma'><p><b>ANTRIAN FARMASI POLIKLINIK</p></b></font>
                                        </center>
                                    </td>   
                                    </td>   
...
<table border='0' cellpadding='0' cellspacing='0' style="width: 100%; margin-top: 10px;">
    <tr style="vertical-align: top;">
        <td width='50%' style="vertical-align: top; padding: 0px 0px;">
            <div class="container-fluid" id="rajal">
            </div>
        </td>
        <!-- 
        <td width='50%' style="vertical-align: top; padding: 0px 0px;">
            <div class="container-fluid" id="ranap">
            </div>
        </td> 
        -->
    </tr>
    ...
    <script type="text/javascript"> 
        ...
        var auto_refresh = setInterval( 
            function() { 
                $('#rajal').load('data_antrianfarmasijudul.php').fadeIn("fast"); 
            }, 5000
        );
/*        var auto_refresh = setInterval( 
            function() { 
                $('#ranap').load('data_antrianfarmasijudulranap.php').fadeIn("fast"); 
            }, 9000
        );
*/
    </script>
