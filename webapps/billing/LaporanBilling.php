    ...
    <?php
        ...
        if(mysqli_num_rows($hasil)!=0) { 
            ...
            <tr class='isi12' padding='0'>
			    ...
			    <td  width='20%'><center><font color='000000' size='2'  face='Tahoma'><b>$carabayar</b></font></center></td>
                        </tr>
                  </table>
            </td>
            </tr>
            <tr>
              <td colspan='7' padding='0'>
               <hr/>
                <center><font color='333333' size='1'  face='Tahoma'><b>BILLING RAWAT JALAN</b></font> </center>
              </td>
            </tr>
            ";  $z=1;
			  ...
			  echo "<font color='000000' size='1'  face='Tahoma'>&nbsp;$inapdrpasien[0]</font></br>";				                    
                ...
                while($inapdrpasien = mysqli_fetch_array($hasil2)) {
                    echo "<tr class='isi12' padding='0'>
                       ...
                       <td padding='0' width='25%' align='right'><font color='000000' size='1'  face='Tahoma'>$inapdrpasien[3]</font></td>              
                      </tr>"; 			                    
                } 
                ...
                echo "<tr class='isi12' padding='0'>
                       ...
                       while($inapdrpasien = mysqli_fetch_array($hasil3)) {
                           if(!empty($inapdrpasien[3])){
                                echo "<tr class='isi12' padding='0'> 
                                         <td padding='0' width='40%'><font color='000000' size='1'  face='Tahoma'>$inapdrpasien[1]</font></td>
                            ...
                            while($inapdrpasien = mysqli_fetch_array($hasil4)) {
                                if(!empty($inapdrpasien[3])){
                                    ...
                                    echo "<tr class='isi12' padding='0'> 
                                              ...
                                              <td padding='0' width='1%'><font color='000000' size='1'  face='Tahoma'></font></td>   
                                              <td padding='0' width='25%' align='right'><font color='000000' size='1'  face='Tahoma'><b>".$inapdrpasien["temp2"]."<b></font></td>              
                                          </tr>";                                    
                                }
                            }
                        echo"</table>
                ...
                while($inapdrpasien = mysqli_fetch_array($hasil5)) {
                    echo "<tr class='isi12' padding='0' colspan='4'>
                       <td padding='0' width='30%'><font color='000000' size='1'  face='Tahoma'>$inapdrpasien[0]</td> 
                       <td padding='0' width='46%' colspan='0'><font color='000000' size='1'  face='Tahoma'>$inapdrpasien[1]</font></td>
                       <td padding='0' width='2%'><font color='111111' size='1'  face='Tahoma'>$inapdrpasien[2]</td>
                       <td padding='0' width='1%'><font color='000000' size='1'  face='Tahoma'>$inapdrpasien[4]</font></td>     
                       <td padding='0' width='25%' align='right'><font color='000000' size='1'  face='Tahoma'>$inapdrpasien[3]</font></td>              
                      </tr>"; 			                    
                ...
                while($inapdrpasien = mysqli_fetch_array($hasil6)) {
                    echo "<tr class='isi12' padding='0' colspan='4'>
                       ...
                       <td padding='0' width='2%'><font color='111111' size='1'  face='Tahoma'>$inapdrpasien[2]</td>
                       <td padding='0' width='1%'><font color='000000' size='1'  face='Tahoma'>$inapdrpasien[4]</font></td>     
                       <td padding='0' width='25%' colspan='4' align='right'><font color='000000' size='1'  face='Tahoma'>$inapdrpasien[3]</font></td>              
                      </tr>"; 			                    
                } 
            ...
            echo "  <tr class='isi12' padding='0'>
			    ...
			    <td colspan='7' padding='0'>&nbsp</td>
                        ...
                        <tr class='isi12' padding='0'>
			    <td colspan='7' padding='0'><font color='000000' size='1'  face='Tahoma'>NB : Mohon maaf apabila ada tagihan yang belum tertagihkan dalam perincian ini akan ditagihkan kemudian hari, dan apabila berlebih akan dikembalikan.</font></td>
                        </tr>
                </table>"; 
