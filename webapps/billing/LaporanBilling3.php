    ...
    <?php
        ...
        if(mysqli_num_rows($hasil)!=0) { 
            ...
            <tr>
              <td colspan='7' padding='0'>
               <hr/>
                <center><font color='333333' size='1'  face='Tahoma'><b>BILLING RAWAT INAP</b></font> </center>
              </td>
            </tr>
            ";  $z=1;
                   ...
                   if($z<=6){
					 ...
					 if(empty($inapdrpasien[6])&&empty($inapdrpasien[0])){
						 ...
						 echo "<tr class='isi12' padding='0'>
                                ...
                                <td padding='0' width='1%' align='right'><font color='111111' size='1'  face='Tahoma'>$inapdrpasien[4]</td>    
                                <td padding='0' width='25%' align='right'><font color='111111' size='1'  face='Tahoma'>$inapdrpasien[6]</td>                
                              </tr>";  
					 }                     
                   }
                  $z++; 
