...
<body>
    <div class="container">
        <h5 class="text-dark"><center><button class="btn btn-secondary" onclick="window.location.reload();">Refresh</button><br/><br/>PERSETUJUAN PEMINDAHAN PASIEN<br>NO.RAWAT <?=$norawat;?></center></h5>
        ...
        <form method="POST" action="pages/storeImage.php" onsubmit="return validasiIsi();" enctype=multipart/form-data>
			...
			<h5 class="text-dark"><center> <br/>ORIENTASI PASIEN BARU<br>NO.RAWAT <?=$norawat;?></center></h5>
			<br>
			<h7 class="text-dark">
				1. Memberi salam pada pasien dan keluarga pasien.<br>
				2. Memperkenalkan diri.<br>
				3. Memperkenalkan perawat yang bertanggung jawab (Kepala Ruangan, Kepala Tim, Perawat Pelaksana).<br>
				4. Memperkenalkan dokter dan tenaga non keperawatan yang bertanggung jawab (Ahli Gizi, Laundry dan Lain-lain).<br>
				5. Penjelasan Peraturan <?=$namars?> serta Hak & Kewajiban Pasien.<br>
				6. Menjelaskan pada pasien dan keluarga pasien tentang semua fasilitas yang tersedia didalam ruang perawatan dan prosedur penggunaanya.<br>
				7. Memperkenalkan ruangan dan lingkungan.<br>
				8. Perawat memberikan informasi cara cuci tangan dan etika batuk serta tempat sampah dan larangan merokok di area <?=$namars?>.<br>
				9. Menganjurkan pasien dan keluarga untuk tidak membawa barang berharga.<br>
				10. Menjelaskan fungsi gelang pasien.<br>
				11. Menjelaskan inventaris ruangan dan fasilitas ruangan.<br>
				12. Menjelaskan penandaan resiko jatuh, cara pencegahan dan fungsi bel di masing-masing bed/kamar mandi.<br>
				13. Menanyakan kembali tentang penjelasan yang telah disampaikan.
			</h7>
			</br>
			<hr />
            <br/>
